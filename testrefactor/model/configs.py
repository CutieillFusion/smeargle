...
"""MAMBA2 configuration Copied from [Transformers](https://github.com/huggingface/transformers/blob/main/src/transformers/models/mamba2/configuration_mamba2.py) modified for Smeargle"""

import math
from transformers.configuration_utils import PretrainedConfig

class SmeargleConfig(PretrainedConfig):
    """
